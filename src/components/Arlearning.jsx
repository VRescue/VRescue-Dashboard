    ...
    const scenarios = [
        {
            ...
            image: image1,
            description: 'Utilize XR Technology to simulate chemical gas leakage scenarios, providing immersive training experiences for trainees in response and safety procedures',
        },
        {
            id: 2,
            title: 'Biological Hazard Training',
            image: image2,
            description: 'Biological Hazard Training can be enhanced with XR Technology, from Theory to Tools, VRescue has got you covered.',
        },
        {
            id: 3,
            title: 'Radiological Incident Drill',
            image: image3,
            description: 'Virtual-Reality simulations offer safe and realistic environments for practicing response procedures with virtual radiological equipment, enhancing skills and preparedness without real-world risks.',
        },
