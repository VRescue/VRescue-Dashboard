...
const TrackingPosture = () => {
  ...
  const trackingAppUrl = "C:/Users/ARYAN/Dropbox/PC/Desktop/posenetdemoml5jsmain/index.html";
      ...
      <div className=" bg-gray-100 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <a className="text-3xl " href="https://teachablemachine.withgoogle.com/models/ScenlU5z_/">Click Here to track posture</a>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
